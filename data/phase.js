...
PhaseInfo.Phase_Options = [
  {
    id: 5,
    display_name: 'Getting_Into_Position',
    name: 'Getting_Into_Position',
    x: 29.5,
    y: 54,
    width: 8,
    height: 13,
    panel_height: 790,
    super_phases: [{ id: 2, x: 400, y: 1200 }],
  },
  {
    id: 2,
    display_name: 'Puck_Collection',
    ...
    height: 13.3,
    panel_height: 1600,
    super_phases: [{ id: 4, x: 400, y: 1200 }],
  },
  {
    id: 4,
    display_name: 'Eliminate_Opposing_Player',
    name: 'Formation_Displacement',
    x: 3.5,
    y: 9,
    width: 0,
    height: 0,
    panel_height: 1600,
    super_phases: [{ id: 2, x: 400, y: 850 }],
  },
  {
    id: 1,
    display_name: 'Wall_Left',
    name: 'Wall_Left',
    x: 24.9,
    y: 39,
    width: 2,
    ...
    pucks: [
      {
        ...
        pin: { x: 0, y: 0 },
        tracks: [],
        arrows: [{ mini_track: null, direction: 'down' }],
      },
      {
        id: 2,
        name: 'Stalling',
    ...
    pucks: [
      {
        ...
        arrows: [
          {
            mini_track: { height: 1300, pin: { x: 255, y: 0 } },
            direction: 'right',
          },
        ],
      },
      {
        ...
        pin: { x: 400, y: 400 },
        tracks: [
          { length: 700, pin: { x: 0, y: 0 }, rotation: 0 },
          { length: 500, pin: { x: -125, y: 300 }, rotation: 30 },
        ],
        arrows: [
          {
            mini_track: { height: 300, pin: { x: -115, y: -100 } },
            direction: 'left',
          },
        ],
      },
      {
        id: 3,
        name: 'Eliminate_Opposing_Player',
        pin: { x: 400, y: 1200 },
        tracks: [],
        arrows: [],
        click: 'Formation_Displacement',
      },
      {
        id: 4,
        name: 'Claim_Empty_Space',
        pin: { x: 100, y: 1200 },
        tracks: [],
        arrows: [],
      },
    ...
    pucks: [
      {
        ...
        arrows: [
          {
            mini_track: { height: 1200, pin: { x: -180, y: 0 } },
            direction: 'left',
            subtitle: { name: 'side_by_side', pin: { x: -450, y: 0 } },
          },
          {
            mini_track: { height: 900, pin: { x: 310, y: 0 } },
            direction: 'right',
            subtitle: { name: 'head_on', pin: { x: 350, y: 0 } },
          },
        ],
      },
      {
        id: 2,
        name: 'Steal_Opponents_Position',
        pin: { x: 400, y: 400 },
        tracks: [{ length: 400, pin: { x: 0, y: 0 }, rotation: 0 }],
        arrows: [],
      },
    ...
    pucks: [
      {
        ...
        arrows: [
          {
            mini_track: { height: 150, pin: { x: 255, y: 0 } },
            direction: 'right',
          },
        ],
      },
      {
        ...
        arrows: [
          {
            mini_track: { height: 700, pin: { x: -115, y: -400 } },
            direction: 'left',
          },
        ],
      },
  ...
  },
  {
    ...
    keys: [
      ...
      },
      {
        ...
        name: 'dummy',
        active: true,
        aliases: ['jinx', 'deek', 'sidestep', 'swerve'],
      },
      {
        id: 37,
        decision: 'head_on',
        card: 'left_option',
        name: 'flick_and_chase',
        active: true,
      },
      {
        id: 38,
      ...
      },
      {
        ...
        decision: 'side_by_side',
        card: 'outside_options',
        name: 'doubleback_windmill',
        active: true,
        aliases: ['180_windmill', '180_hook_push'],
      },
      {
        id: 122,
        decision: 'head_on',
    ...
    keys: [
      {
        ...
        decision: 'Wall_Right',
        card: 'Leaving',
        name: 'windmill_kickoff',
        active: true,
        aliases: ['hook_push_kickoff', 'the_9', 'halfmoon'],
      },
      {
        id: 56,
        decision: 'Wall_Right',
      ...
      },
      {
        ...
        decision: 'Wall_Right',
        card: 'Leaving',
        name: 'Pin_Roll_CW_Curl',
        active: true,
        aliases: ['Pin_and_Spin'],
      },
    ],
  },
]
